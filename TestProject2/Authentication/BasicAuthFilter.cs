...
namespace TestProject2.Authentication
{
    ...
    public class BasicAuthFilter : Attribute, IAuthenticationFilter
    {
        ...
        /// <summary>
        /// Parse basic auth credentials into username and password
        /// </summary>
        /// <param name="credentials"></param>
        /// <returns> Tuple<string ,string> where first item is subject and second is password</returns>

        private Tuple<string, string> ParseBasicAuthCredential(string credentials)
        {
            string password = null;

            var subject = Encoding.GetEncoding("iso-8859-1").GetString(Convert.FromBase64String(credentials));
